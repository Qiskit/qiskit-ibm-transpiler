...
from qiskit_transpiler_service.utils import (
...
def test_deprecation_warning():
    with catch_warnings(record=True) as w:
        ...
        assert (
            str(w[0].message)
            == "The package qiskit-transpiler-service is deprecated. Use qiskit-ibm-transpiler instead. Version 0.4.14 will be the last one, no more fixes will be applied"
        )
